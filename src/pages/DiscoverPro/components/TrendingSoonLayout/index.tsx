...
import TrendingSoonTokenItem from 'pages/DiscoverPro/components/TrendingSoonLayout/TrendingSoonTokenItem'
import TrendingSoonTokenDetail from 'pages/DiscoverPro/components/TrendingSoonLayout/TrendingSoonTokenDetail'
