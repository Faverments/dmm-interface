...
import TrendingSoonTokenItemDetailsOnMobile from 'pages/DiscoverPro/components/TrendingSoonTokenItemDetailsOnMobile'
    ...
    return (
      ...
      >
        ...
        <Text fontSize="12px" color={isSelected ? theme.primary : theme.subText}>
          {tokenData.discovered_on == 0 ? '--' : date}
        </Text>
        ...
        <Flex alignItems="center">
          ...
          <Flex flexDirection="column" style={{ gap: '4px', marginLeft: '8px' }}>
            ...
            <Text fontSize="12px" color={theme.subText}>
              <Trans>Discovered on</Trans>: {tokenData.discovered_on == 0 ? '--' : date}
            </Text>
          </Flex>
        </Flex>
        {tokenIndex === undefined ? (
