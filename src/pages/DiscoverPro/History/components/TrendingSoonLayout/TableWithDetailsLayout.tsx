...
// import useGetTrueSightFilterData, {
//   TrueSightFilterTokenData,
//   TrueSightFilterTokenResponse,
// } from 'pages/DiscoverPro/hooks/useGetTrueSightFilterData'
...
//   } = useGetTrueSightHistoryData(filter.timeframe, headerDetails.selectedPredictedDate)

//   const filterTrueSightHistoryData = useFilterTrueSightHistoryData(trueSightHistoryRes, filter)
...
//   useEffect(() => {
//     setCurrentPage(1)
//   }, [filter, headerDetails.selectedPredictedDate])
...
//     <>
//       <TrueSightContainer>
//         {sortedPaginatedDiscoverProTokens.length == 0 || isLoadingTrueSightHistoryRes ? (
//           <LocalLoader />
