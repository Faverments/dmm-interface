...
import useGetListTrueSightFilterData from 'pages/DiscoverPro/hooks/useGetListTrueSightFilterData-v0'
...
export default function useTopTrendingSoonTokensInCurrentNetwork() {
  ...
  const { data: trendingSoon1dData, loading: isTrendingSoon1dDataLoading } = useGetListTrueSightFilterData('24h', [
    1652573532,
    // 1652055336,
    // 1652055334,
    // 11652011912,
