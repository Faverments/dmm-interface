...
export default function DiscoverProPageDropwdown({}) {
  ...
  return (
    <HoverDropdown active={pathname.toLowerCase().includes('discoverpro')}>
      <Flex alignItems="center">
        <Trans>Pro</Trans>
        <DropdownIcon />
      </Flex>
      <Dropdown>
        <StyledNavLink id={`discoverpro-truesight`} to={'/discoverpro/truesight'} isActive={match => Boolean(match)}>
          <Trans>TrueSight</Trans>
        </StyledNavLink>

        <StyledNavLink id={`discoverpro-History`} to={'/discoverpro/history'} isActive={match => Boolean(match)}>
          <Trans>History</Trans>
        </StyledNavLink>
