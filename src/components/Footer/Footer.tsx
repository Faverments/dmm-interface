...
import Tomo from 'assets/svg/faverments.svg'
...
export const FooterSocialLink = () => {
  ...
  return (
    <Flex alignItems="center" justifyContent="center" sx={{ gap: '24px' }}>
      <ExternalLinkNoLineHeight href="https://t.me/TomoChainChannel">
        <Telegram size={16} color={theme.subText} />
      </ExternalLinkNoLineHeight>
      <ExternalLinkNoLineHeight href="https://twitter.com/TomoChainANN">
      ...
      <ExternalLinkNoLineHeight href={`https://medium.com/tomochain`}>
        <Medium />
      </ExternalLinkNoLineHeight>
    </Flex>
  )
      ...
      <FooterContent>
        <InfoWrapper>
          <Item>
            ...
            <ExternalLink href="https://tomochain.com" style={{ display: 'flex' }}>
              {/* {isDarkMode ? <PoweredByIconDark width={48} /> : <PoweredByIconLight width={48} />} */}
              <img src={Tomo} alt="tomo" height={30} />
            </ExternalLink>
          </Item>
          <Separator />
