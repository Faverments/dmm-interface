...
import Lz from 'assets/svg/faverments.svg'
...
export const FooterSocialLink = () => {
  ...
  return (
    <Flex alignItems="center" justifyContent="center" sx={{ gap: '24px' }}>
      <ExternalLinkNoLineHeight href="https://t.me/lzofficial">
        <Telegram size={16} color={theme.subText} />
      </ExternalLinkNoLineHeight>
      <ExternalLinkNoLineHeight href="https://twitter.com/launchzoneann">
      ...
      <FooterContent>
        <InfoWrapper>
          <Item>
            ...
            <ExternalLink href="https://www.launchzone.vn" style={{ display: 'flex' }}>
              {/* {isDarkMode ? <PoweredByIconDark width={48} /> : <PoweredByIconLight width={48} />} */}
              <img src={Lz} alt="logo" width="48" />
            </ExternalLink>
          </Item>
          <Separator />
