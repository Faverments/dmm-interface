...
import Kar from 'assets/images/faverments.png'
...
export const FooterSocialLink = () => {
  ...
  return (
    <Flex alignItems="center" justifyContent="center" sx={{ gap: '24px' }}>
      <ExternalLinkNoLineHeight href="https://t.me/kardiachain">
        <Telegram size={16} color={theme.subText} />
      </ExternalLinkNoLineHeight>
      <ExternalLinkNoLineHeight href="https://twitter.com/KardiaChain">
      ...
      <FooterContent>
        <InfoWrapper>
          <Item>
            ...
            <ExternalLink href="https://www.kardiachain.io" style={{ display: 'flex' }}>
              {/* {isDarkMode ? <PoweredByIconDark width={48} /> : <PoweredByIconLight width={48} />} */}
              <img src={Kar} alt="kar" height={30} />
            </ExternalLink>
          </Item>
          <Separator />
